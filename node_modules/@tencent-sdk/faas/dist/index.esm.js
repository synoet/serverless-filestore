...
import { ServiceType, ApiFactory, pascalCaseProps, CommonError, camelCaseProps } from '@tencent-sdk/common';
    ...
    Monitor.prototype.request = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, APIS$1[Action](this.capi, pascalCaseProps(data))];
                    case 1:
                        result = _b.sent();
...
var FaaS = /** @class */ (function () {
    ...
    FaaS.prototype.request = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, APIS[Action](this.capi, pascalCaseProps(data))];
                    case 1:
                        result = _b.sent();
                        return [2 /*return*/, result];
                }
    ...
    FaaS.prototype.invoke = function (_a) {
        var name = _a.name, _b = _a.namespace, namespace = _b === void 0 ? 'default' : _b, _c = _a.qualifier, qualifier = _c === void 0 ? '$LATEST' : _c, _d = _a.event, event = _d === void 0 ? {} : _d, _e = _a.logType, logType = _e === void 0 ? LogType.tail : _e, _f = _a.invokeType, invokeType = _f === void 0 ? InvokeType.request : _f;
        return __awaiter(this, void 0, void 0, function () {
            var detail, Result;
            return __generator(this, function (_g) {
                switch (_g.label) {
                    ...
                    case 2:
                        ...
                        return [2 /*return*/, camelCaseProps(Result)];
                }
            });
        });
    };
...
export { FaaS, LogType, InvokeType, Monitor };
